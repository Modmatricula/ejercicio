 ...
 */
public class ConRet extends javax.swing.JFrame {
...
public void setMenu(String menu){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        con.SetConsi(jTextField1.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       re.setVisible(true);
       this.setVisible(false);
       re.setReti(jTextField1.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConRet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
